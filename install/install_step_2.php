...
<form class="form-horizontal" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="install_step_2_4" class="form-control" id="input_4" value="<?php echo (check_value($_SESSION['install_sql_db1']) ? $_SESSION['install_sql_db1'] : 'GunzDB'); ?>">
			<p class="help-block">Usually <strong>GunzDB</strong>. WebEngine tables will be created in this database.</p>
		</div>
	</div>
	<!-- <div class="form-group">
		...
		<div class="col-sm-10">
			...
			<p class="help-block">Usually <strong>GunzDBv2</strong>. Leave empty if you only use one database.</p>
		</div>
	</div> -->
	<div class="form-group">
