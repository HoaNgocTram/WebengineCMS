		...
		if(check_value($_POST['characteredit_submit'])) {
			try {
				...
				$query = "UPDATE "._TBL_CHR_." SET ";
					...
					$query .= _CLMN_CHR_PK_KILLS_ . " = :pklevel,";
			...
			echo '<div class="col-md-6">';
				...
				echo '<div class="panel-body">';
					echo '<table class="table table-no-border table-hover">';
						...
						echo '</tr>';*/
						echo '<tr>';
							echo '<th>Kill Count:</th>';
							echo '<td><input class="form-control" type="number" name="characteredit_pklevel" value="'.$charData[_CLMN_CHR_PK_KILLS_].'"/></td>';
						echo '</tr>';
					echo '</table>';
				echo '</div>';
				echo '</div>';
