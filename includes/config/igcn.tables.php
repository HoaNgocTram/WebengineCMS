...
define('_TBL_CHR_', 'Character');
	...
	define('_CLMN_CHR_ACCID_', 'AID');	//AccountID
	define('_CLMN_CHR_CLASS_', 'Sex');	//Class
	define('_CLMN_CHR_ZEN_', 'Money');
	define('_CLMN_CHR_LVL_', 'Level');	//cLevel
	define('_CLMN_CHR_RSTS_', 'DeathCount');	//RESETS
	define('_CLMN_CHR_GRSTS_', 'XP');	//GrandResets
	define('_CLMN_CHR_LVLUP_POINT_', 'LevelUpPoint');	//LevelUpPoint
	define('_CLMN_CHR_STAT_STR_', 'BP');	//Strength
	define('_CLMN_CHR_STAT_AGI_', 'LC');	//Dexterity
	define('_CLMN_CHR_STAT_VIT_', 'Hair');	//Vitality
	define('_CLMN_CHR_STAT_ENE_', 'Face');	//Energy
	define('_CLMN_CHR_STAT_CMD_', 'Leadership');
	define('_CLMN_CHR_PK_KILLS_', 'KillCount');	//PkCount
	define('_CLMN_CHR_PK_LEVEL_', 'PkLevel');	//PkLevel
...
define('_TBL_MASTERLVL_', 'Character');
	...
	define('_CLMN_ML_LVL_', 'Level');	//mLevel
...
define('_TBL_GUILDMEMB_', 'GuildMember');
	define('_CLMN_GUILDMEMB_CHAR_', 'CID');		//Name
...
define('_TBL_CH_', 'Login'); //ConnectionHistory
	define('_CLMN_CH_ID_', 'ID');
	define('_CLMN_CH_ACCID_', 'AccountID');
	define('_CLMN_CH_SRVNM_', 'ServerName');
	define('_CLMN_CH_IP_', 'LastIP');	//IP
	define('_CLMN_CH_DATE_', 'LastConnDate'); //Date
	define('_CLMN_CH_STATE_', 'State');
	define('_CLMN_CH_HWID_', 'Hwid');	//HWID
	
/*
 * custom: character_class
 */
$custom['character_class'] = array(
	0 => array('Male', 'DW', 'male.jpg', 'base_stats' => array('str' => 18, 'agi' => 18, 'vit' => 15, 'ene' => 30, 'cmd' => 0), 'class_group' => 0),
	1 => array('Female', 'SM', 'female.jpg', 'base_stats' => array('str' => 18, 'agi' => 18, 'vit' => 15, 'ene' => 30, 'cmd' => 0), 'class_group' => 0),
