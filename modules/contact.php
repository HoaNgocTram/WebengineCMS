		...
		echo '<div class="panel-body">';
			echo '<form action="" method="post">';
				echo '<div class="form-group">';
					...
					echo '<input type="email" class="form-control" id="contactInput1" name="contact_email" value="hotro@gunz.vn" readonly>';
				echo '</div>';
				echo '<div class="form-group">';
					echo '<label for="contactInput2">'.lang('contactus_txt_2',true).'</label>';
					echo '<textarea class="form-control" id="contactInput2" style="height:250px;" name="contact_message" placeholder="Hãy để lại Email của bạn trong tin nhắn này để chúng tôi có thể phản hồi"></textarea>';
				echo '</div>';
