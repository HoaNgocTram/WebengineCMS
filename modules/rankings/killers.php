...
try {
	...
	echo '<td style="font-weight:bold;">Kill</td>';
	...
	foreach($ranking_data as $rdata) {
		...
		if($i>=1) {
			...
			{
				if ($rdata[3] == 0)
				echo '<td><img src="https://gunz.vn/gunz/img/male.png" class="emblem width="25" height="25""/></td>';
				else if ($rdata[3] == 1)
				echo '<td><img src="https://gunz.vn/gunz/img/female.png" class="emblem width="25" height="25""/></td>';
			}
			echo '<td>'.number_format($rdata[1]).'</td>';
			echo '<td style="color:red;">'.number_format($rdata[2]).'</td>';
